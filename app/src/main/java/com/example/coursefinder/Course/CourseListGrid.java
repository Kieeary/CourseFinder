...
public class CourseListGrid extends BaseAdapter{
    private Context mContext;
    private final String[] buttonStr;

    public CourseListGrid(Context c, String[] buttonStr ) {
        mContext = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            grid = inflater.inflate(R.layout.courselist_grid_single, null);
