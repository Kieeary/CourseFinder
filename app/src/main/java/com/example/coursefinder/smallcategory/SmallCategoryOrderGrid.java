...
public class SmallCategoryOrderGrid extends BaseAdapter{
    private Context mContext;
    private final String[] buttonStr;

    public SmallCategoryOrderGrid(Context c, String[] buttonStr ) {
        mContext = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            grid = inflater.inflate(R.layout.small_category_order_grid_single, null);
